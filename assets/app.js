...
document.querySelectorAll('[data-role="slider-wrapper"]').forEach(function (gallery) {
  var slides = Array.from(gallery.querySelectorAll('[data-role="slide"]'));
  var prev = gallery.querySelector('[data-role="prev"]');
  var next = gallery.querySelector('[data-role="next"]');
  var index = gallery.querySelector('[data-role="slide-index"]');
  var current = 0;

  var showSlide = function showSlide(num) {
  ...
  slides.forEach(function (slide) {
    var touch = new hammerjs__WEBPACK_IMPORTED_MODULE_3___default.a(slide);
...
flatpickr__WEBPACK_IMPORTED_MODULE_2___default()("#arrival", {});
flatpickr__WEBPACK_IMPORTED_MODULE_2___default()("#departure", {});
