...
<head>
    ...
    <body class="leading-normal font-sans text-grey-main bodywrap">
                ...
                <nav>
                    <ul class="flex flex-row list-reset p-16">
                        <li class="border-r border-solid border-grey">
                            <a href="<?= $page->url('en') ?>" class="block px-16 uppercase type-14 tracking-wide <?php e('en' == $kirby->language()->code(), ' font-regular ', ' font-bold ') ?>">eng</a>
                        </li>
                        <li>
                            <a href="<?= $page->url('gr') ?>" class="block px-16 uppercase type-14 tracking-wide <?php e('gr' == $kirby->language()->code(), ' font-regular ', ' font-bold ') ?>">ελλ</a>
                        </li>
                    </ul>
                </nav>
            </div>
