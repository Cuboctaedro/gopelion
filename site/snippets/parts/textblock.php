<div class="w-full md:w-650 lg:w-710 md:flex-none px-16 sm:px-p7 text-center md:text-left flex flex-col <?php e($layout == 'textimage', ' md:pl-100 lg:pl-160 md:pr-50 ', ' md:pr-100 lg:pr-160 md:pl-50 md:order-2 '); ?> <?php e($link != false, ' justify-end '); ?> ">
